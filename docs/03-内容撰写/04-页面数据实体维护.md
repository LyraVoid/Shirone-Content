...
> 配图说明：
> - 建议截图内容：/devices/ 设备展示页顶部分类筛选 Chips、Featured 推荐设备卡片与硬件规格徽章
> - 对应保存路径：`docs/images/03-content/05-devices-page-preview.png`

![个人设备展示页排版效果](../images/03-content/05-devices-page-preview.png)
...
> 配图说明：
> - 建议截图内容：/timeline/ 大事记时间线页面，展示左侧年份节点、右侧里程碑高亮卡片与标签
> - 对应保存路径：`docs/images/03-content/06-timeline-page-preview.png`

![大事记时间线页面节点展示](../images/03-content/06-timeline-page-preview.png)
