...
> 配图说明：
> - 建议截图内容：/moments/ 说说时间轴页面，展示时间戳节点、心情图标胶囊徽章以及多图网格展示效果
> - 对应保存路径：`docs/images/03-content/03-moments-timeline-preview.png`

![说说时间轴与九宫格多图效果](../images/03-content/03-moments-timeline-preview.png)
