...
> 配图说明：
> - 建议截图内容：/albums/ 相册汇总页的大图封面卡片列表与点击进入后的瀑布流画廊效果
> - 对应保存路径：`docs/images/03-content/04-albums-masonry-preview.png`

![瀑布流相册首页与照片画廊排版](../images/03-content/04-albums-masonry-preview.png)
