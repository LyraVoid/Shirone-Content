...
> 配图说明：
> - 建议截图内容：GitHub 新建仓库表单界面，重点框选仓库名输入框、Private 选项以及不要勾选初始文件的区域
> - 对应保存路径：`docs/images/01-quickstart/01-github-create-repo.png`
...
> 配图说明：
> - 建议截图内容：刚创建好的空白仓库指引页面，重点框选复制 SSH 或 HTTPS 仓库链接的位置
> - 对应保存路径：`docs/images/01-quickstart/02-repo-initial-page.png`
