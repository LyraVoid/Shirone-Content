...
![追番页面展示与进度条效果](../images/02-config/07-anime-page-preview.png)
...
![Bilibili ID获取](../images/02-config/08-bilibili-id.png)

#### Bilibili SESSDATA 获取方式：
在浏览器开发者工具中找到存储的 Cookie 项：

![Bilibili SESSDATA获取](../images/02-config/09-bilibili-sessdata.png)
