...
![Cloudflare Workers与Pages首页](../images/04-deploy/02-1-cloudflare.png)
*图 1-1：Cloudflare Workers 与 Pages 控制台首页*

![选择 Pages 部署方式](../images/04-deploy/02-2-pages-deploy.png)
*图 1-2：在创建页面底部选择 Pages 部署*

![连接 GitHub 账户](../images/04-deploy/02-3-github-connect.png)
*图 1-3：连接并授权 GitHub 账户*

![选择主题代码仓库](../images/04-deploy/02-4-shirone-connect.png)
*图 1-4：选择你的主题代码仓库*

![配置构建设置与生产分支](../images/04-deploy/02-5-default-build.png)
...
![配置环境变量](../images/04-deploy/02-6-env-config.png)
...
![部署挂钩配置入口](../images/04-deploy/02-7-deploy-hook-config.png)
*图 1-7：在项目设置中找到部署挂钩并点击添加*

![Webhook 创建成功与复制](../images/04-deploy/02-8-webhook-success.png)
...
![新建 Repository secret 配置](../images/04-deploy/02-9-github-secret-config.png)
*图 1-9：在 GitHub 内容仓添加 `CLOUDFLARE_DEPLOY_HOOK` Secret*

![Repository secrets 列表](../images/04-deploy/02-10-repository-secrets.png)
*图 1-10：Secret 创建保存界面*

![Secret 配置完成](../images/04-deploy/02-11-actions-repository-secrets.png)
...
![EdgeOne 钩子创建位置](../images/04-deploy/02-12edgeone-deploy-hook.png)
